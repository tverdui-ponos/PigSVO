...
class Pig(NPC):
	def __init__(self,x,y):
		super().__init__(x,y,hp=40, speed=4, damage=1, filename="materials/npc/pig/pig.png", width=100, height=100, groups=(visible_sprites, physical_sprites, obstacle_sprites, npcs, enemys_npcs))
	def move_idle(self):
