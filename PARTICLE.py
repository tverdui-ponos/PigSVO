...
class BloodParticle(Particle):
	def __init__(self, x, y, groups):
		super().__init__(x,y, 15, 15, r.uniform(-10.0, 10.0), r.uniform(-10.0, 10.0), BLOOD_COLOR[r.randint(0,4)], groups)
...
class Bullet(Particle):
	...
	def __init__(self, sender, direction, groups):
		...
		if length_of_vector(distance) >= 0:

			velocity = normalize_vector(distance)
